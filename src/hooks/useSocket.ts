...
export function useSocket(
    ...
    interface PlayerJoinData { room?: string; roomId?: string; name: string; color: string; hat: string; charType?: number; hairColor?: string; clothingColor?: string; faceShape?: number; nameLabelColor?: string; title?: string; labelEffect?: string; mapId?: string; }
